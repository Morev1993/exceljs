...
XLSX.prototype = {
  ...
  _finalize(zip) {
    console.log('ZIP IN FINALIZE', zip);
    return new PromiseLib.Promise((resolve, reject) => {
      zip.on('finish', () => {
        console.log('finish');
        resolve(this);
